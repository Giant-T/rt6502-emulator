...
TEST_CASE("STA IndexedIndirect", "[Instruction][STA][INDX]") {
    size_t cyclesCounters = 0;
    size_t bytesCounters = 1;
    ...
    const auto [instruction, reg, index_reg] = GENERATE_REF(
        Params{INS_STA_INDX, emulator.Cpu.A, emulator.Cpu.X}
    );
    ...
    emulator.Mem[0x0005] = 0x20;

    emulator.Mem[0x001E] = 0x67;
    emulator.Mem[0x001F] = 0x45;
    emulator.Mem[0x0020] = 0x34;
    emulator.Mem[0x0021] = 0x12;
